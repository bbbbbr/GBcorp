...
const unsigned char tiles_data[] = {
  ...
  // GBA Off
  0xFF,0x00,0xFF,0x7F,0xC0,0x7F,0xDF,0x7F,
  0xDF,0x70,0xDF,0x70,0xDF,0x76,0xDF,0x70,
  0xFF,0x00,0xFF,0xFE,0x03,0xFE,0xFB,0xFE,
  0xFB,0x0E,0xFB,0x0E,0xFB,0x6E,0xFB,0x0E,
...
const unsigned char map_linked_buddy[7][5] = {
    { 0x00, 0x00, 0x00, 0x00, 0x00 }, // Empty
    { 0xE6, 0xE7, 0xE6, 0xBB, 0xBC }, // DMG
    { 0xE6, 0xE7, 0xE6, 0xC1, 0xC2 }, // MGB
    { 0xE6, 0xE7, 0xE6, 0xC7, 0xC8 }, // CGB
    { 0xE6, 0xE7, 0xE6, 0xCD, 0xCE }, // SGB
    { 0xE6, 0xE7, 0xE6, 0xDE, 0xDF }, // GBA
